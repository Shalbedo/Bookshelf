 ...
 */
final class Version20221101190108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, owner_id INT NOT NULL, book_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, text TEXT NOT NULL, rating INT DEFAULT NULL, PRIMARY KEY(id))');
